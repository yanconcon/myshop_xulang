...
def get_ali_object():
    ...
    app_id = "2016091100484880"  #  APPID （沙箱应用）
    ...
    # 支付完成后，跳转的地址。
    return_url = "http://{}{}".format('127.0.0.1:8000', reverse('payment:page2'))
...
def page1(request):
    ...
    money = '%.2f' % float(order.get_total_cost())

    alipay = get_ali_object()

    # 生成支付的url
    query_params = alipay.direct_pay(
        subject="product",  # 商品简单描述
